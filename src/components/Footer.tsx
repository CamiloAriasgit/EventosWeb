      ...
      <ul className="flex justify-around">
        <li>
          <a href="#home" className="flex flex-col items-center text-white hover:text-gray-300">
            {/* Aquí va el SVG del ícono de Home */}
            <svg
              className="w-6 h-6 mb-1" // Clases de Tailwind para tamaño y margen
              viewBox="-1 0 19 19"
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink" // Cambiado a camelCase
              fill="currentColor" // Usa currentColor para que herede el color de Tailwind
            >
        ...
        {/* Aquí irían los otros enlaces con sus respectivos SVGs */}
        <li>
          <a href="#products" className="flex flex-col items-center text-white hover:text-gray-300">
            {/* SVG del ícono de Productos */}
            <span className="text-xs">Productos</span>
          </a>
        </li>
        <li>
          <a href="#contact" className="flex flex-col items-center text-white hover:text-gray-300">
            {/* SVG del ícono de Contacto */}
